from app.input_reader import _is_youtube_url, extract_text
import pytest
...
def test_get_text_unsupported_file_type():
    ...
    with pytest.raises(ValueError, match="Invalid document path!"):
        extract_text(unsupported_file_path)
